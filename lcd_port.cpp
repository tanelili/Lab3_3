...
void delayMicroseconds(int us)
{
	...
	if(us % 1000 != 0) ms++;
	Sleep(ms);
	/*Tätä SLEEPPIÄ pitää käyttää! Näyttö ei pysy perässä 72Mhz virkistyksen kanssa, siksi pitää hidastaa. T:Keijo
	use systick timer at 1000 Hz for this you need to implement Sleep() - hint: adapt it from the earli */
}
